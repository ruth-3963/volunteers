    ...
    MultiSelect.prototype.updateValue = function (event, li, state) {
        ...
        if (li && li.length) {
            ...
            while (index_1 < length && index_1 <= 50 && index_1 < count_1) {
                ...
                if (state) {
                    hiddenValue += '<option selected value ="' + this.value[index_1] + '">' + index_1 + '</option>';
                }
                index_1++;
            }
            ...
            if (length > 50) {
                setTimeout(function () {
                    ...
                    while (index_1 < length && index_1 < count_1) {
                        ...
                        if (state) {
                            hiddenValue += '<option selected value ="' + _this.value[index_1] + '">' + index_1 + '</option>';
                        }
                        index_1++;
                    }
                    if (!(isBlazor() && _this.isServerRendered)) {
                        _this.hiddenElement.innerHTML += hiddenValue;
