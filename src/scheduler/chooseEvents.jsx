...
const ChooseEvents = (props) => {
  ...
  return (<div>
    ...
    <ScheduleComponent actionBegin={(args) => onActionBegin(args)} ref={c => calendar.current = c} width='100%' height='550px' eventSettings={{ dataSource: events }} popupOpen={(args) => penPopUp(args)}>
      <ResourcesDirective>
